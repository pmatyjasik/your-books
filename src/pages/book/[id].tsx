		...
		<>
			...
			{isSuccess && (
				<div className="flex justify-center">
					<div className="flex flex-col w-full rounded-lg shadow-xl xl:w-4/5">
						<div className="flex p-2 rounded-t-lg shadow-md bg-primary ">
							...
							<div className="flex flex-col items-center justify-center w-full text-xl font-bold text-center text-white rounded-t-lg sm:text-2xl bg-primary">
								<p className="inline-block w-full pt-4 text-white rounded-t-lg">
									{title ? title : '-'}
								</p>
								...
								<p className="px-2 pt-3 pb-4 text-base font-light">
									{categories ? categories : ''}
								</p>
							</div>
						</div>
						<div className="rounded-b-lg min-h bg-secondary">
							<div className="flex justify-center p-4 sm:justify-end">
								<Button>Add to table</Button>
							</div>
							<div className="w-full px-4 pb-4 text-white sm:px-6 xl:px-12 xl:pb-8">
								{description ? (
									<div
